...
<head>
  ...
  <title>@yield('title') | TechAnalytica Administration</title>
  <meta name="description" content="TechAnalytica Administration & Analytics Dashboard" />
  ...
  @include('backend.admin.layouts.sections.scriptsIncludes')
