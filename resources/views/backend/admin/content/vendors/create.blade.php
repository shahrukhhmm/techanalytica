...
@section('content')
    <div class="container-xxl flex-grow-1 container-p-y">
        <h4 class="fw-bold mb-4"><span class="text-muted fw-light">Vendors /</span> Add Vendor</h4>
            ...
            <div class="col-md-8 mx-auto">
                <div class="card mb-4">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        ...
                        <small class="text-muted float-end">New Vendor Account</small>
                    </div>
                    <div class="card-body">
                        <form action="{{ route('admin.vendors.store') }}" method="POST">
                            ...
                            <div class="mb-3">
                                ...
                                @enderror
                                <div class="form-text text-muted small">Only users without an existing vendor profile are
                                    shown.</div>
                            </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control @error('company_size') is-invalid @enderror"
                                        id="company_size" name="company_size" value="{{ old('company_size') }}"
                            ...
                            <div class="mb-4">
                                ...
                                <textarea class="form-control @error('billing_address') is-invalid @enderror" id="billing_address"
                                    name="billing_address" rows="3" placeholder="Full billing address...">{{ old('billing_address') }}</textarea>
