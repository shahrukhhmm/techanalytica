    ...
    <div class="auth-login-wrapper">
        ...
        <div class="auth-glass-card">
            ...
            <div class="text-center mb-4">
                ...
                <p style="color: var(--text-secondary); font-size: 13.5px; margin: 0;">Access your vendor dashboard,
                    analytics, or administrative portal.</p>
            </div>
            ...
            <form id="formAuthentication" action="{{ route('login') }}" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <div class="auth-input-group">
                        ...
                        <input type="text" class="auth-input-field @error('email-username') is-invalid @enderror"
                            id="email" name="email-username" value="{{ old('email-username') }}"
                            placeholder="admin@techanalytica.com" required autofocus />
                    </div>
                ...
                <div class="mb-3">
                    <div class="d-flex justify-content-between align-items-center mb-2">
                        ...
                        <a href="{{ url('auth/forgot-password-basic') }}"
                            style="color: #ff735c; font-size: 12.5px; font-weight: 600; text-decoration: none;">Forgot
                            password?</a>
                    </div>
                    <div class="auth-input-group">
                        <span class="auth-input-icon">
                        ...
                        <input type="password" id="password"
                            class="auth-input-field @error('password') is-invalid @enderror" name="password"
                            placeholder="••••••••••••" required />
                        <button type="button" class="toggle-pwd-btn" onclick="togglePasswordVisibility()"
                ...
                <div class="mb-4 d-flex justify-content-between align-items-center">
                    <div class="form-check">
                        <input class="form-check-input" type="checkbox" name="remember-me" id="remember-me"
                            style="background-color: rgba(255,255,255,0.06); border-color: rgba(255,255,255,0.2);" />
                        <label class="form-check-label text-muted small" for="remember-me" style="cursor: pointer;">Remember
                            me on this browser</label>
                    </div>
                </div>
            ...
            <div class="text-center mt-3">
                <a href="{{ url('/') }}"
                    style="color: var(--text-secondary); font-size: 12.5px; text-decoration: none;"
                    onmouseover="this.style.color='#ff3b7b'" onmouseout="this.style.color='var(--text-secondary)'">
