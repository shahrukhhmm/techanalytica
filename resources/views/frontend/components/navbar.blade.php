...
<head>
    ...
    <style>
        ...
        nav {
            ...
            background-color: rgba(239, 242, 239, 0.65);
            /* light: #EFF2EF with opacity */
            backdrop-filter: blur(6px);
            border-bottom: 1px solid rgba(229, 231, 235, 0.35);
        }

        nav.scrolled {
            background-color: rgba(239, 242, 239, 0.96);
...
<body class="bg-gradient-to-br from-gray-50 via-[#EFF2EF]/40 to-white min-h-screen text-[#353531]">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex items-center justify-between h-16 md:h-20 transition-all duration-500">
                ...
                <a href="#" class="flex items-center gap-2.5">
                    <div
                        class="w-9 h-9 rounded-xl bg-gradient-to-br from-primary to-accent flex items-center justify-center text-white font-bold text-lg shadow-md">
                        TA
                    </div>
                    <span
                        class="text-xl md:text-2xl font-extrabold bg-gradient-to-r from-primary to-accent bg-clip-text text-transparent">
                        Techanalytica
                    </span>
                </a>
                ...
                <div class="hidden md:flex items-center justify-center flex-1 space-x-8 lg:space-x-10 xl:space-x-12">
                    ...
                    <div class="relative group has-dropdown">
                        ...
                        <div
                            class="absolute left-1/2 -translate-x-1/2 top-full pt-5 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 pointer-events-none group-hover:pointer-events-auto w-[720px] max-w-[90vw]">
                            <div class="bg-white rounded-2xl shadow-2xl border border-gray-100/70 overflow-hidden p-8">
                                <div class="grid grid-cols-2 gap-6">
                                    <a href="#"
                                        class="mega-item flex items-start gap-4 p-5 rounded-xl transition duration-200">
                                        <div class="text-3xl flex-shrink-0">💻</div>
                                        <div>
                                            <h4 class="font-semibold text-dark group-hover:text-primary">Project
                                                Management</h4>
                                    ...
                                    <a href="#"
                                        ...
                                        <div class="text-3xl flex-shrink-0">📊</div>
                                        <div>
                                            <h4 class="font-semibold text-dark group-hover:text-primary">Analytics & BI
                                            </h4>
                                    ...
                                    <a href="#"
                                        ...
                                        <div class="text-3xl flex-shrink-0">🛒</div>
                                        <div>
                                            <h4 class="font-semibold text-dark group-hover:text-primary">E-commerce
                                                Platforms</h4>
                                    ...
                                    <a href="#"
                                        ...
                                        <div class="text-3xl flex-shrink-0">📧</div>
                                        <div>
                                            <h4 class="font-semibold text-dark group-hover:text-primary">Marketing
                                                Automation</h4>
                ...
                <div class="hidden md:block flex-shrink-0">
                    <a href="#"
                        class="bg-gradient-to-r from-primary via-secondary to-accent text-white font-semibold px-6 py-2.5 rounded-full hover:shadow-xl hover:shadow-primary/30 transition transform hover:-translate-y-0.5 text-sm lg:text-base">
                        Join or Login
                    </a>
                </div>
    ...
    <div id="mobile-menu" class="fixed inset-0 bg-black/60 z-50 hidden">
        <div
            class="absolute right-0 top-0 bottom-0 w-4/5 max-w-sm bg-white shadow-2xl transform translate-x-full transition-transform duration-300 ease-in-out">
            <div class="p-6 flex flex-col h-full">
                <div class="flex justify-between items-center mb-10">
                    <span
                        class="text-xl font-bold bg-gradient-to-r from-primary to-accent bg-clip-text text-transparent">Menu</span>
                ...
                <nav class="flex flex-col space-y-5 text-base font-medium">
                    ...
                    <a href="#"
                        class="bg-gradient-to-r from-primary to-accent text-white py-3 px-6 rounded-full text-center mt-6">Join
                        or Login</a>
                </nav>
            </div>
        </div>
    ...
    <div class="min-h-screen flex items-center justify-center text-center px-6">
        <div>
            <h1
                class="text-5xl md:text-7xl font-extrabold bg-gradient-to-r from-primary via-secondary to-accent bg-clip-text text-transparent mb-6">
                No Gradient Navbar
            </h1>
